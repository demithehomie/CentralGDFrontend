...
type FingerPrintStoriesDataType = {
  ...
  const FingerPHStoriesGT: React.FC = () => {
...
const handleCopy = async () => {
  ...
  return (
    ...
    <div>
      ...
      <br />
      <br />
      <h3 style={{ color: '#ffffff'}}>GUERRATOOL - Fingerprint Logs</h3>

      <button onClick={fingerprintsTMT}>Check The Magic Tool Fingerprints</button>
      <br /><br />
...
export default FingerPHStoriesGT;
