...
export default function ValidacaoeRelatiorios() {
...
const shouldRenderItem = (transfer: TransferData) => {
 ...
 // const twoMinutesAgo = new Date(currentTime.getTime() - 2 * 60 * 1000); // 2 minutes ago
  ...
  return (
    ...
    <div>
        <br /><br /><br /><br />
    <h3 className="title"> Status dos Clientes</h3>
    <Table columns={clientes} dataSource={pendingTransfers} loading={isLoading}/>
    <br />
