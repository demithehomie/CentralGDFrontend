...
type CreditDataType = {
  ...
  const fetchDataWithDates = async () => {
    try {
      const response = await axios.get(`${apiurl}/themagictool/users/creditlogs-with-pagination`, {
        params: {
          page: currentPage,
