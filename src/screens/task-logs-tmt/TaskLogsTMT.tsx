...
type TaskDataType = {
  ...
  const fetchDataWithDates = async () => {
    try {
      const response = await axios.get(`${apiurl}/themagictool/users/tasklogs-with-pagination`, {
        params: {
          page: currentPage,
          limit: 10,
...
const handleCopy = async () => {
  ...
  return (
    ...
    <div>
        ...
        <br />
        <br />
    <h3 style={{ color: '#ffffff'}}>The Magic Tool - Task Logs</h3>
   
    <button onClick={taskLogsGt}>Check GUERRATOOL Task Logs</button>
    <br />br
